...
class TestRunConversationCodexPath:
    ...
    def test_custom_provider_key_is_passed_to_codex_app_server(self, monkeypatch):
        """The Codex child must use Hermes' resolved custom-provider key,
        rather than inheriting an unrelated OPENAI_API_KEY."""
        captured: dict = {}
    ...
    def test_frozen_yolo_env_auto_approves_codex_server_requests(self, monkeypatch):
