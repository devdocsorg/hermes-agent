...
class TestApply:
    ...
    def test_reapply_codex_app_server_runs_migration(self):
        ...
        with (
            ...
            mig.return_value.wrote_permissions_default = ":danger-full-access"
        ...
        assert "Default sandbox: :danger-full-access" in r.message
        ...
        # on every re-apply).
        assert persisted == {}, "persist_callback fired despite no config-value change"
