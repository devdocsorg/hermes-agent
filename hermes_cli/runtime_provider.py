...
def _maybe_apply_codex_app_server_runtime(
    *,
    ...
    this function is a no-op. Only native OpenAI/Codex providers are eligible.
    Custom providers remain on their configured transport even when they point
    at a loopback proxy such as LiteLLM.
