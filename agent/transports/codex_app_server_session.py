    ...
    def run_turn(
        ...
        *,
        ...
        if (
            ...
            # Two very different situations reach here, and treating them
            # alike shipped a mid-work note to Slack as a final answer
            # (2026-07-28, 12:14 and 19:31):
            #   a) codex ANSWERED then went quiet, omitting turn/completed.
            #   b) codex was STILL WORKING when the clock ran out.
            # Tell them apart by whether codex was still emitting notifications
            # as the deadline approached. The silence window reuses the file's
            # established "codex has stopped" constant, clamped to half the
            # budget so a short-budget caller/test still gets a real window.
