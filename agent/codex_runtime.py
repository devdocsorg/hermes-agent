...
def run_codex_app_server_turn(
    ...
    *,
    ...
    if not hasattr(agent, "_codex_session") or agent._codex_session is None:
        ...
        # Codex app-server reads its model-provider credential from the
        # subprocess environment. For a custom runtime, force it to use the
        # key Hermes already resolved for this agent instead of inheriting an
        # unrelated process-level OPENAI_API_KEY.
        app_server_env = (
